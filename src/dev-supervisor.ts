 ...
 * (`<dir>/fastagent` — so nothing in the surrounding workspace ever triggers a restart). Ignoring a
 * directory prunes the whole subtree, so everything outside the allowlist —
